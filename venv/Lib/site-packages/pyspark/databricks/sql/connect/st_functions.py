...
from pyspark.sql.connect.functions import builtin as ossfc
...
def st_azimuth(col1: "ColumnOrName", col2: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_azimuth", col1, col2)


st_azimuth.__doc__ = pyspark_db_st_funcs.st_azimuth.__doc__


def st_boundary(col: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_boundary", col)


st_boundary.__doc__ = pyspark_db_st_funcs.st_boundary.__doc__
...
def st_closestpoint(col1: "ColumnOrName", col2: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_closestpoint", col1, col2)


st_closestpoint.__doc__ = pyspark_db_st_funcs.st_closestpoint.__doc__
...
def st_estimatesrid(col: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_estimatesrid", col)


st_estimatesrid.__doc__ = pyspark_db_st_funcs.st_estimatesrid.__doc__
...
def st_force2d(col: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_force2d", col)


st_force2d.__doc__ = pyspark_db_st_funcs.st_force2d.__doc__


def st_geogfromewkt(col: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_geogfromewkt", col)


st_geogfromewkt.__doc__ = pyspark_db_st_funcs.st_geogfromewkt.__doc__
...
def st_geogfromwkb(col: "ColumnOrName") -> "Column":
    return ossfc.st_geogfromwkb(col)
...
def st_geomfromewkt(col: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_geomfromewkt", col)


st_geomfromewkt.__doc__ = pyspark_db_st_funcs.st_geomfromewkt.__doc__
...
def st_geomfromwkb(
    ...
    return ossfc.st_geomfromwkb(col1, col2)
...
def st_makeenvelope(
    ...
    return _invoke_function_over_columns("st_makeenvelope", x1, y1, x2, y2)


st_makeenvelope.__doc__ = pyspark_db_st_funcs.st_makeenvelope.__doc__
...
def st_makepoint(*cols: "ColumnOrName") -> "Column":
    ...
    return _invoke_function_over_columns("st_makepoint", *cols)


st_makepoint.__doc__ = pyspark_db_st_funcs.st_makepoint.__doc__
...
def st_nrings(col: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_nrings", col)


st_nrings.__doc__ = pyspark_db_st_funcs.st_nrings.__doc__


def st_numpoints(col: "ColumnOrName") -> "Column":
    return _invoke_function_over_columns("st_numpoints", col)


st_numpoints.__doc__ = pyspark_db_st_funcs.st_numpoints.__doc__
...
def st_setsrid(col1: "ColumnOrName", col2: Union["ColumnOrName", int]) -> "Column":
    return ossfc.st_setsrid(col1, col2)
