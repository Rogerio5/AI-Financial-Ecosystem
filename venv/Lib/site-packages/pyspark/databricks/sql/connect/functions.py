...
from pyspark.databricks.sql.connect.inet_functions import (  # noqa: F401
    ip_host,  # noqa: F401
    ip_cidr,  # noqa: F401
...
def user_home_catalog() -> Column:
    ...
    return _invoke_function("user_home_catalog")


user_home_catalog.__doc__ = pyspark_db_funcs.user_home_catalog.__doc__
