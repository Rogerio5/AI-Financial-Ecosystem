...
class SparkContext:
    ...
    def _do_init(
        ...
        # BEGIN-EDGE
        # .. connect_migration:: Replace `spark.sparkContext.appName` with
    ...
    def applicationId(self) -> str:
        ...
        * in case of YARN something like 'application_1433865536131_34483'
        ...
        # BEGIN-EDGE
        .. connect_migration:: Replace `spark.sparkContext.applicationId` with
    ...
    def parallelize(self, c: Iterable[T], numSlices: Optional[int] = None) -> RDD[T]:
        ...
        # BEGIN-EDGE
        .. connect_migration:: Replace `sc.parallelize(data)` with the Python collection
            directly. When used with `createDataFrame`: `spark.createDataFrame(data, schema)`.
        # END-EDGE
        """
        numSlices = int(numSlices) if numSlices is not None else self.defaultParallelism
    ...
    def setLocalProperty(self, key: str, value: str) -> None:
        ...
        # BEGIN-EDGE
        .. connect_migration:: Replace `spark.sparkContext.setLocalProperty(key, value)`
            with `spark.conf.set(key, value)`.
        # END-EDGE
        """
    ...
    def getConf(self) -> SparkConf:
        ...
        # BEGIN-EDGE
        .. connect_migration:: Replace `sc.getConf()` with `spark.conf`. For a specific
            key use `spark.conf.get(key)`.
        # END-EDGE
        """
        conf = SparkConf()
    ...
    def resources(self) -> Dict[str, ResourceInformation]:
        ...
        PipelineSparkConnectMigrationTelemetry.detect_get_resources_command_in_query_fn()
        # END-EDGE
        resources = {}
