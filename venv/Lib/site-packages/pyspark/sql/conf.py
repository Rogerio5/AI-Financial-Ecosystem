...
class RuntimeConfig:
    ...
    def set(self, key: str, value: Union[str, int, bool]) -> None:
        ...
        log_runtime_config_access("set", key, jconf=self._jconf)
        PipelineSparkConnectMigrationTelemetry.detect_spark_conf_set(key, value)
        # END-EDGE
    ...
    def get(
        ...
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("get", key, jconf=self._jconf)
        # END-EDGE
    ...
    def getAll(self) -> Dict[str, str]:
        ...
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("getAll", key=None, jconf=self._jconf)
        # END-EDGE
    ...
    def unset(self, key: str) -> None:
        ...
        log_runtime_config_access("unset", key, jconf=self._jconf)
        PipelineSparkConnectMigrationTelemetry.detect_spark_conf_unset(key)
        # END-EDGE
    ...
    def isModifiable(self, key: str) -> bool:
        ...
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("isModifiable", key, jconf=self._jconf)
        # END-EDGE
