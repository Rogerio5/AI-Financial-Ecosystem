...
class DataStreamWriter:
    ...
    def foreach(self, f: Union[Callable[[Row], None], "SupportsProcess"]) -> "DataStreamWriter":
        ...
        # BEGIN-EDGE
        python_env = self._session.client._pythonEnv
        if python_env:
            self._write_proto.foreach_writer.python_function.environment.CopyFrom(python_env.to_proto())
        # END-EDGE
        return self
    ...
    def foreachBatch(self, func: Callable[["DataFrame", int], None]) -> "DataStreamWriter":
        ...
        python_env = self._session.client._pythonEnv
        if python_env:
            self._write_proto.foreach_batch.python_function.environment.CopyFrom(python_env.to_proto())
        # END-EDGE
        return self
