...
class RuntimeConf:
    ...
    def set(self, key: str, value: Union[str, int, bool]) -> None:
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("set", key, session_id=self._client._session_id)
        # END-EDGE
    ...
    def get(
        ...
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("get", key, session_id=self._client._session_id)
        # END-EDGE
    ...
    def getAll(self) -> Dict[str, str]:
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("getAll", key=None, session_id=self._client._session_id)
        # END-EDGE
    ...
    def unset(self, key: str) -> None:
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("unset", key, session_id=self._client._session_id)
        # END-EDGE
    ...
    def isModifiable(self, key: str) -> bool:
        # BEGIN-EDGE
        from pyspark.databricks.instrumentation.runtime_config_access_logger import log_runtime_config_access
        log_runtime_config_access("isModifiable", key, session_id=self._client._session_id)
        # END-EDGE
...
def _test() -> None:
    ...
    # BEGIN-EDGE
    del pyspark.sql.connect.conf.RuntimeConf.get.__doc__
    del pyspark.sql.connect.conf.RuntimeConf.set.__doc__
    del pyspark.sql.connect.conf.RuntimeConf.unset.__doc__
    # END-EDGE
