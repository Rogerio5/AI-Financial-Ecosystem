...
class Expression(google.protobuf.message.Message):
    ...
    class RollingWindowMeasure(google.protobuf.message.Message):
        """BEGIN-EDGE
        Expression for rolling window measure aggregations in streaming queries.
        This represents an aggregate function combined with a rolling window range specification.
        """

        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        class RollingWindowRangeSpec(google.protobuf.message.Message):
            """Window range specification for a rolling window measure."""

            DESCRIPTOR: google.protobuf.descriptor.Descriptor

            PRECEDING_RANGE_DURATION_FIELD_NUMBER: builtins.int
            preceding_range_duration: builtins.str
            """Duration string before the frontier to include (e.g., "10 seconds", "5 minutes")."""
            def __init__(
                self,
                *,
                preceding_range_duration: builtins.str = ...,
            ...
            def HasField(
                self,
                field_name: typing_extensions.Literal[
                    "preceding_range_duration",
                    b"preceding_range_duration",
                    "range_type",
                    b"range_type",
                ],
            ) -> builtins.bool: ...
            ...
            def WhichOneof(
                self, oneof_group: typing_extensions.Literal["range_type", b"range_type"]
            ) -> typing_extensions.Literal["preceding_range_duration"] | None: ...

        AGGREGATE_EXPR_FIELD_NUMBER: builtins.int
        RANGE_SPEC_FIELD_NUMBER: builtins.int
        @property
        def aggregate_expr(self) -> global___Expression:
            """(Required) The aggregate expression to compute (e.g., sum, count, avg)."""
        @property
        def range_spec(self) -> global___Expression.RollingWindowMeasure.RollingWindowRangeSpec:
            """(Required) The window range specification for this measure."""
        def __init__(
            self,
            *,
            aggregate_expr: global___Expression | None = ...,
            range_spec: global___Expression.RollingWindowMeasure.RollingWindowRangeSpec
            | None = ...,
        ) -> None: ...
        def HasField(
            self,
            field_name: typing_extensions.Literal[
                "aggregate_expr", b"aggregate_expr", "range_spec", b"range_spec"
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
    ...
    ROLLING_WINDOW_MEASURE_FIELD_NUMBER: builtins.int
    ...
    @property
    def rolling_window_measure(self) -> global___Expression.RollingWindowMeasure:
        """EDGE"""
    @property
    ...
    def __init__(
        ...
        *,
        ...
        rolling_window_measure: global___Expression.RollingWindowMeasure | None = ...,
