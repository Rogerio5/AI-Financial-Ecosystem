...
class Command(google.protobuf.message.Message):
    ...
    QUERCUS_COMMAND_FIELD_NUMBER: builtins.int
    ...
    @property
    def quercus_command(self) -> global___QuercusCommand:
        """BEGIN-EDGE
        EXPERIMENTAL / WIP: Quercus proto API is under active development,
        will change, and must not be used in production yet.
        Quercus materialized view caching command.
        END-EDGE
        """
    @property
    ...
    def __init__(
        ...
        *,
        ...
        quercus_command: global___QuercusCommand | None = ...,
...
class QuercusCommand(google.protobuf.message.Message):
    """BEGIN-EDGE
    EXPERIMENTAL / WIP: Quercus proto API is under active development,
    will change, and must not be used in production yet.

    Command to execute a query through the Quercus materialized view cache.
    The server will create or refresh a materialized view (MV) backed by the query
    ...
    def input(self) -> pyspark.sql.connect.proto.relations_pb2.Relation:
        """(Required) The query to cache/serve from MV."""
    catalog: builtins.str
    """(Required) Unity Catalog catalog that owns the backing MV."""
    schema: builtins.str
    """(Required) Unity Catalog schema that owns the backing MV."""
    target_name: builtins.str
    """(Optional) Explicit MV table name. When omitted, the server derives a stable
    name from a hash of the canonicalized query plan.
    """
    def __init__(
        self,
        *,
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_target_name", b"_target_name", "input", b"input", "target_name", b"target_name"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_target_name", b"_target_name"]
    ) -> typing_extensions.Literal["target_name"] | None: ...

global___QuercusCommand = QuercusCommand

class QuercusCommandResult(google.protobuf.message.Message):
    """EXPERIMENTAL / WIP: see QuercusCommand.
    Result of a QuercusCommand execution.
    """
    ...
    class _StateEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            QuercusCommandResult._State.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        STATE_UNSPECIFIED: QuercusCommandResult._State.ValueType  # 0
        STATE_RUNNING: QuercusCommandResult._State.ValueType  # 1
        """Async: operation is in progress."""
        STATE_SUCCEEDED: QuercusCommandResult._State.ValueType  # 2
        """Operation completed successfully."""
        STATE_FAILED: QuercusCommandResult._State.ValueType  # 3
        """Operation failed."""

    class State(_State, metaclass=_StateEnumTypeWrapper): ...
    STATE_UNSPECIFIED: QuercusCommandResult.State.ValueType  # 0
    STATE_RUNNING: QuercusCommandResult.State.ValueType  # 1
    """Async: operation is in progress."""
    STATE_SUCCEEDED: QuercusCommandResult.State.ValueType  # 2
    """Operation completed successfully."""
    STATE_FAILED: QuercusCommandResult.State.ValueType  # 3
    """Operation failed."""
    ...
    """The technique used for the refresh.
    Values: NoOp, AppendOnly, SPUJ, CompleteRecompute, Passthrough, Fallback
    """
    state: global___QuercusCommandResult.State.ValueType
    """Current state of the operation (create or refresh)."""
    error_message: builtins.str
    """(Optional) Error message if state is FAILED or technique is Fallback."""
    resolved_table_name: builtins.str
    """(Optional) Fully-qualified table name of the created/refreshed MV
    (e.g. "catalog.schema.mv_name"). Returned when the server resolves
    the target name (including auto-derived names from the plan hash).
    """
    def __init__(
        self,
        *,
        ...
        resolved_table_name: builtins.str | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_error_message",
            b"_error_message",
            "_resolved_table_name",
            b"_resolved_table_name",
            "error_message",
            b"error_message",
            "resolved_table_name",
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_resolved_table_name", b"_resolved_table_name"],
    ) -> typing_extensions.Literal["resolved_table_name"] | None: ...

global___QuercusCommandResult = QuercusCommandResult
