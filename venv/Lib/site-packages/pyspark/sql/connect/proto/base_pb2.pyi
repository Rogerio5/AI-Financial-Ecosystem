...
class ExecutePlanResponse(google.protobuf.message.Message):
    ...
    QUERCUS_COMMAND_RESULT_FIELD_NUMBER: builtins.int
    EXTENSION_FIELD_NUMBER: builtins.int
    METRICS_FIELD_NUMBER: builtins.int
    ...
    def pipeline_query_function_execution_signal(
        ...
        """
    @property
    def quercus_command_result(self) -> pyspark.sql.connect.proto.commands_pb2.QuercusCommandResult:
        """BEGIN-EDGE
        EXPERIMENTAL / WIP: Quercus proto API is under active development,
        will change, and must not be used in production yet.
        Response for Quercus materialized view caching command.
        END-EDGE
        """
    @property
    def extension(self) -> google.protobuf.any_pb2.Any:
    ...
    def __init__(
        ...
        *,
        ...
        | None = ...,
        quercus_command_result: pyspark.sql.connect.proto.commands_pb2.QuercusCommandResult
        | None = ...,
        extension: google.protobuf.any_pb2.Any | None = ...,
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "quercus_command_result",
            b"quercus_command_result",
            "response_type",
            b"response_type",
            "result_complete",
            b"result_complete",
...
class TargetUser(google.protobuf.message.Message):
    """Target user context for admin operations."""
    ...
    SESSION_ID_FIELD_NUMBER: builtins.int
    user_id: builtins.str
    """(Required) User ID of the target session owner."""
    session_id: builtins.str
    """(Required) Session ID of the target."""
    def __init__(
        self,
        *,
        user_id: builtins.str = ...,
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["session_id", b"session_id", "user_id", b"user_id"],
    ) -> None: ...

global___TargetUser = TargetUser

class AdminInterruptRequest(google.protobuf.message.Message):
    """Admin interrupt request - allows cluster admins to interrupt operations in other users' sessions."""

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    class InterruptAll(google.protobuf.message.Message):
        """Empty message to indicate interrupting all operations."""
    ...
    OPERATION_ID_FIELD_NUMBER: builtins.int
    INTERRUPT_ALL_FIELD_NUMBER: builtins.int
    CLIENT_TYPE_FIELD_NUMBER: builtins.int
    @property
    def target(self) -> global___TargetUser:
        """(Required) Target user and session to interrupt."""
    operation_id: builtins.str
    """Interrupt a specific operation by ID."""
    @property
    def interrupt_all(self) -> global___AdminInterruptRequest.InterruptAll:
        """Interrupt all operations in the session."""
    client_type: builtins.str
    """(Optional) Client type for logging purposes."""
    def __init__(
        self,
        *,
        target: global___TargetUser | None = ...,
        operation_id: builtins.str = ...,
        interrupt_all: global___AdminInterruptRequest.InterruptAll | None = ...,
        client_type: builtins.str | None = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["interrupt_type", b"interrupt_type"]
    ) -> typing_extensions.Literal["operation_id", "interrupt_all"] | None: ...

global___AdminInterruptRequest = AdminInterruptRequest

class AdminInterruptResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    TARGET_USER_ID_FIELD_NUMBER: builtins.int
    TARGET_SESSION_ID_FIELD_NUMBER: builtins.int
    INTERRUPTED_IDS_FIELD_NUMBER: builtins.int
    target_user_id: builtins.str
    """User ID of the target session owner (echoed from request)."""
    target_session_id: builtins.str
    """Session ID (echoed from request)."""
    @property
    def interrupted_ids(
        self,
    ) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """List of operation IDs that were interrupted."""
    def __init__(
        self,
        *,
        target_user_id: builtins.str = ...,
...
global___AdminInterruptResponse = AdminInterruptResponse

class AdminReleaseSessionRequest(google.protobuf.message.Message):
    """Admin release session request - allows cluster admins to release other users' sessions."""
    ...
    @property
    def target(self) -> global___TargetUser:
        """(Required) Target user and session to release."""
    client_type: builtins.str
    """(Optional) Client type for logging purposes."""
    def __init__(
        self,
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_client_type", b"_client_type", "client_type", b"client_type", "target", b"target"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
global___AdminReleaseSessionRequest = AdminReleaseSessionRequest

class AdminReleaseSessionResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "target_session_id", b"target_session_id", "target_user_id", b"target_user_id"
        ],
    ) -> None: ...

global___AdminReleaseSessionResponse = AdminReleaseSessionResponse
