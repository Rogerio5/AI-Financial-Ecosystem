...
class SparkConnectAdminServiceStub(object):
    """BEGIN-EDGE
    Admin service for cluster administrators to manage other users' sessions.
    This service is only available via the gateway (not on local unix domain socket).
    Admin privilege validation is performed in AuthenticationInterceptor.
    """
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.AdminInterrupt = channel.unary_unary(
            "/spark.connect.SparkConnectAdminService/AdminInterrupt",
            request_serializer=spark_dot_connect_dot_base__pb2.AdminInterruptRequest.SerializeToString,
            response_deserializer=spark_dot_connect_dot_base__pb2.AdminInterruptResponse.FromString,
            _registered_method=True,
        )
        self.AdminReleaseSession = channel.unary_unary(
            "/spark.connect.SparkConnectAdminService/AdminReleaseSession",
            request_serializer=spark_dot_connect_dot_base__pb2.AdminReleaseSessionRequest.SerializeToString,
            response_deserializer=spark_dot_connect_dot_base__pb2.AdminReleaseSessionResponse.FromString,
            _registered_method=True,
        )


class SparkConnectAdminServiceServicer(object):
    """BEGIN-EDGE
    Admin service for cluster administrators to manage other users' sessions.
    This service is only available via the gateway (not on local unix domain socket).
    Admin privilege validation is performed in AuthenticationInterceptor.
    ...
    def AdminInterrupt(self, request, context):
        """Allows cluster admins to interrupt operations in sessions belonging to other users."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")

    def AdminReleaseSession(self, request, context):
        """Allows cluster admins to release sessions belonging to other users."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")


def add_SparkConnectAdminServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "AdminInterrupt": grpc.unary_unary_rpc_method_handler(
            servicer.AdminInterrupt,
            request_deserializer=spark_dot_connect_dot_base__pb2.AdminInterruptRequest.FromString,
            response_serializer=spark_dot_connect_dot_base__pb2.AdminInterruptResponse.SerializeToString,
        ),
        "AdminReleaseSession": grpc.unary_unary_rpc_method_handler(
            servicer.AdminReleaseSession,
            request_deserializer=spark_dot_connect_dot_base__pb2.AdminReleaseSessionRequest.FromString,
            response_serializer=spark_dot_connect_dot_base__pb2.AdminReleaseSessionResponse.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        "spark.connect.SparkConnectAdminService", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
...
# This class is part of an EXPERIMENTAL API.
class SparkConnectAdminService(object):
    """BEGIN-EDGE
    Admin service for cluster administrators to manage other users' sessions.
    This service is only available via the gateway (not on local unix domain socket).
    Admin privilege validation is performed in AuthenticationInterceptor.
    ...
    def AdminInterrupt(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/spark.connect.SparkConnectAdminService/AdminInterrupt",
            spark_dot_connect_dot_base__pb2.AdminInterruptRequest.SerializeToString,
            spark_dot_connect_dot_base__pb2.AdminInterruptResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AdminReleaseSession(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/spark.connect.SparkConnectAdminService/AdminReleaseSession",
            spark_dot_connect_dot_base__pb2.AdminReleaseSessionRequest.SerializeToString,
            spark_dot_connect_dot_base__pb2.AdminReleaseSessionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
