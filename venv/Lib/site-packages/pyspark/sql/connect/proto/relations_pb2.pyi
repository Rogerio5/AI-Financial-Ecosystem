...
class Relation(google.protobuf.message.Message):
    ...
    ROLLING_WINDOW_FIELD_NUMBER: builtins.int
    ...
    def ml_relation(self) -> global___MlRelation:
        """ML relation"""
    @property
    def rolling_window(self) -> global___RollingWindowAggregate:
        """BEGIN-EDGE
        END-EDGE
        """
    @property
    ...
    def __init__(
        ...
        *,
        ...
        rolling_window: global___RollingWindowAggregate | None = ...,
...
class RollingWindowAggregate(google.protobuf.message.Message):
    """BEGIN-EDGE
    Relation of type [[RollingWindowAggregate]].

    Represents a rolling window aggregation operation for streaming queries.
    This operation computes aggregates over time-based windows that slide
    relative to a frontier (either processing time or event time).
    """

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    class FrontierSpec(google.protobuf.message.Message):
        """Frontier specification for rolling window operations."""
        ...
        ALIAS_FIELD_NUMBER: builtins.int
        time_mode: builtins.str
        """(Required) Time mode string for frontier advancement.
        Valid values: "NoTime", "ProcessingTime", "EventTime"
        """
        delay_duration: builtins.str
        """(Required) The delay duration string for frontier advancement (e.g., "0 seconds", "10 seconds")."""
        alias: builtins.str
        """(Required) The alias for the frontier column in output."""
        def __init__(
            self,
            *,
            time_mode: builtins.str = ...,
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
                "alias", b"alias", "delay_duration", b"delay_duration", "time_mode", b"time_mode"
            ],
        ) -> None: ...

    INPUT_FIELD_NUMBER: builtins.int
    PARTITION_BY_NAMES_FIELD_NUMBER: builtins.int
    ORDER_BY_NAME_FIELD_NUMBER: builtins.int
    FRONTIER_SPEC_FIELD_NUMBER: builtins.int
    MEASURES_FIELD_NUMBER: builtins.int
    @property
    def input(self) -> global___Relation:
        """(Required) Input relation for a RollingWindowAggregate."""
    @property
    def partition_by_names(
        self,
    ) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """(Required) Column names to partition by."""
    order_by_name: builtins.str
    """(Required) Column name to order by (timestamp column)."""
    @property
    def frontier_spec(self) -> global___RollingWindowAggregate.FrontierSpec:
        """(Required) The frontier specification (time mode, delay, alias)."""
    @property
    def measures(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        ...
        """(Required) List of measure expressions.
        Each measure must be a RollingWindowMeasure expression (Expression.rolling_window_measure).
        """
    def __init__(
        self,
        *,
        input: global___Relation | None = ...,
        partition_by_names: collections.abc.Iterable[builtins.str] | None = ...,
        order_by_name: builtins.str = ...,
        frontier_spec: global___RollingWindowAggregate.FrontierSpec | None = ...,
        measures: collections.abc.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["frontier_spec", b"frontier_spec", "input", b"input"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            ...
            b"order_by_name",
            "partition_by_names",
            b"partition_by_names",
        ],
    ) -> None: ...

global___RollingWindowAggregate = RollingWindowAggregate
