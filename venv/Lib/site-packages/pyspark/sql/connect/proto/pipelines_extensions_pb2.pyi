...
class _SCDTypeEnumTypeWrapper(
    ...
    SCD_TYPE_BITEMPORAL: _SCDType.ValueType  # 3
...
SCD_TYPE_BITEMPORAL: SCDType.ValueType  # 3
...
class AutoCdcFlowDetails(google.protobuf.message.Message):
    ...
    SYSTEM_SEQUENCE_BY_FIELD_NUMBER: builtins.int
    source: builtins.str
    ...
    @property
    def system_sequence_by(self) -> pyspark.sql.connect.proto.expressions_pb2.Expression:
        """System sequence expression for BITEMPORAL storage type."""
    def __init__(
        self,
        *,
        ...
        system_sequence_by: pyspark.sql.connect.proto.expressions_pb2.Expression | None = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_system_sequence_by", b"_system_sequence_by"]
    ) -> typing_extensions.Literal["system_sequence_by"] | None: ...
    @typing.overload
    def WhichOneof(
...
class AutoCdcFromSnapshotFlowDetails(google.protobuf.message.Message):
    """Details for Apply Changes From Snapshot (ACFS) flows.
    This message is meant to be used in the extension field of PipelineCommand.DefineFlow.
    """

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    SNAPSHOT_SOURCE_FIELD_NUMBER: builtins.int
    SNAPSHOT_FUNCTION_FIELD_NUMBER: builtins.int
    KEYS_FIELD_NUMBER: builtins.int
    STORED_AS_SCD_TYPE_FIELD_NUMBER: builtins.int
    TRACK_HISTORY_COLUMN_LIST_FIELD_NUMBER: builtins.int
    TRACK_HISTORY_EXCEPT_COLUMN_LIST_FIELD_NUMBER: builtins.int
    PROCESS_ONCE_FIELD_NUMBER: builtins.int
    MAX_SNAPSHOTS_PER_FLOW_EXECUTION_FIELD_NUMBER: builtins.int
    SLICE_COLUMN_LIST_FIELD_NUMBER: builtins.int
    snapshot_source: builtins.str
    """The name of the source table/view to read snapshots from."""
    @property
    def snapshot_function(self) -> pyspark.sql.connect.proto.expressions_pb2.PythonUDF:
        """Python function that returns (DataFrame, version) tuples.
        The function signature is: (last_version: Optional[Any]) -> Optional[Tuple[DataFrame, Any]]
        Uses PythonUDF proto which includes pickled command bytes, python_ver, etc.
        """
    @property
    def keys(
        self,
    ...
    def track_history_except_column_list(
        ...
        """Columns not tracked for change history."""
    process_once: builtins.bool
    """If true, the source function is only called once per pipeline update."""
    max_snapshots_per_flow_execution: builtins.int
    """Maximum number of snapshots to process per flow execution."""
    @property
    def slice_column_list(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        pyspark.sql.connect.proto.expressions_pb2.Expression
    ]:
        """Columns identifying the slices present in this snapshot."""
    def __init__(
        self,
        *,
        snapshot_source: builtins.str = ...,
        snapshot_function: pyspark.sql.connect.proto.expressions_pb2.PythonUDF | None = ...,
        keys: collections.abc.Iterable[pyspark.sql.connect.proto.expressions_pb2.Expression]
        | None = ...,
        stored_as_scd_type: global___SCDType.ValueType = ...,
        track_history_column_list: collections.abc.Iterable[
        ...
        | None = ...,
        process_once: builtins.bool | None = ...,
        max_snapshots_per_flow_execution: builtins.int | None = ...,
        slice_column_list: collections.abc.Iterable[
            pyspark.sql.connect.proto.expressions_pb2.Expression
        ]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_max_snapshots_per_flow_execution",
            b"_max_snapshots_per_flow_execution",
            "_process_once",
            b"_process_once",
            "max_snapshots_per_flow_execution",
            b"max_snapshots_per_flow_execution",
            "process_once",
            b"process_once",
            "snapshot_function",
            b"snapshot_function",
    ...
    def WhichOneof(
        ...
        oneof_group: typing_extensions.Literal[
            "_max_snapshots_per_flow_execution", b"_max_snapshots_per_flow_execution"
        ],
    ) -> typing_extensions.Literal["max_snapshots_per_flow_execution"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_process_once", b"_process_once"]
    ) -> typing_extensions.Literal["process_once"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["source", b"source"]
    ) -> typing_extensions.Literal["snapshot_source", "snapshot_function"] | None: ...

global___AutoCdcFromSnapshotFlowDetails = AutoCdcFromSnapshotFlowDetails

class ForeachBatchSinkDetails(google.protobuf.message.Message):
    """Metadata for foreach batch sinks, only applicable to SDP pipelines.
    This allows sink definitions to include a Python function that processes each micro-batch.
    This message is meant to be used in the extension field of PipelineCommand.DefineOutput.details.
    """

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    FOREACH_BATCH_FUNCTION_FIELD_NUMBER: builtins.int
    @property
    def foreach_batch_function(self) -> pyspark.sql.connect.proto.expressions_pb2.PythonUDF:
        """Python function for foreach batch processing.
        Uses PythonUDF proto which includes pickled command bytes, python_ver, etc.
        """
    def __init__(
        self,
        *,
        foreach_batch_function: pyspark.sql.connect.proto.expressions_pb2.PythonUDF | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_foreach_batch_function",
            b"_foreach_batch_function",
            "foreach_batch_function",
            b"foreach_batch_function",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal[
            "_foreach_batch_function", b"_foreach_batch_function"
        ],
    ) -> typing_extensions.Literal["foreach_batch_function"] | None: ...

global___ForeachBatchSinkDetails = ForeachBatchSinkDetails
...
class EdgeWriteRelationFlowDetails(google.protobuf.message.Message):
    ...
    REPLACE_WHERE_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def replace_where(self) -> pyspark.sql.connect.proto.expressions_pb2.Expression:
        """A predicate expression used for selective overwrites (replaceWhere) by Delta Lake."""
    def __init__(
        self,
        *,
        ...
        replace_where: pyspark.sql.connect.proto.expressions_pb2.Expression | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_replace_where", b"_replace_where"]
    ) -> typing_extensions.Literal["replace_where"] | None: ...
...
class EventHookPipelineCommand(google.protobuf.message.Message):
    """Registers a Python event hook with the pipeline.
    Packed into PipelineCommand.extension (google.protobuf.Any).
    """

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    EVENT_HOOK_FUNCTION_FIELD_NUMBER: builtins.int
    HOOK_NAME_FIELD_NUMBER: builtins.int
    MAX_ALLOWABLE_CONSECUTIVE_FAILURES_FIELD_NUMBER: builtins.int
    @property
    def event_hook_function(self) -> pyspark.sql.connect.proto.expressions_pb2.PythonUDF:
        """Cloudpickle-serialized Python event hook function.
        Signature: (event: dict) -> None
        """
    hook_name: builtins.str
    """Hook name (from Python function name). Must be unique across hooks."""
    max_allowable_consecutive_failures: builtins.int
    """Max consecutive failures before hook is disabled. Absent = never disable."""
    def __init__(
        self,
        *,
        event_hook_function: pyspark.sql.connect.proto.expressions_pb2.PythonUDF | None = ...,
        hook_name: builtins.str | None = ...,
        max_allowable_consecutive_failures: builtins.int | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_event_hook_function",
            b"_event_hook_function",
            "_hook_name",
            b"_hook_name",
            "_max_allowable_consecutive_failures",
            b"_max_allowable_consecutive_failures",
            "event_hook_function",
            b"event_hook_function",
            "hook_name",
            b"hook_name",
            "max_allowable_consecutive_failures",
            b"max_allowable_consecutive_failures",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_event_hook_function", b"_event_hook_function"],
    ) -> typing_extensions.Literal["event_hook_function"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_hook_name", b"_hook_name"]
    ) -> typing_extensions.Literal["hook_name"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal[
            "_max_allowable_consecutive_failures", b"_max_allowable_consecutive_failures"
        ],
    ) -> typing_extensions.Literal["max_allowable_consecutive_failures"] | None: ...

global___EventHookPipelineCommand = EventHookPipelineCommand
