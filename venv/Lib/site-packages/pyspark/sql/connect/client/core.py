        ...
        for key, value in trailers:
            ...
            if key == self.LAST_SEEN_EFFECTIVE_USAGE_POLICY_ID_KEY:
                ...
                if current_policy is None:
                    logger.warning(f"Effective usage policy for this session is {latest_policy}.")
...
class SparkConnectClient(object):
    ...
    def to_pandas(
        ...
        table, schema, metrics, observed_metrics, _ = self._execute_and_fetch(
            req, observations, None, selfDestruct == "true" # EDGE
        )
        assert table is not None
        ei = ExecutionInfo(metrics, observed_metrics)
    ...
    def _execute_and_fetch_as_iterator(
        ...
        def handle_response(
            ...
            if b.HasField("pipeline_query_function_execution_signal"):
                yield {
                    "pipeline_query_function_execution_signal": b.pipeline_query_function_execution_signal
                }
    ...
    def _handle_rpc_error_with_error_info(
        ...
        if error_class == "INVALID_PARAMETER_VALUE.INVALID_CLIENT_IMAGE_VERSION":
            raise SparkConnectGrpcException(
                ...
                "https://docs.databricks.com/aws/en/dev-tools/databricks-connect/requirements#databricks-connect-versions",  # noqa: E501
        ...
        if error_class == "CONNECT_INVALID_PLAN.CANNOT_PARSE":
            ...
            logger.info(f"Disabling plan compression for the session due to {error_class} error.")
    ...
    def add_artifacts(
        ...
        *paths: str,
        ...
        self._add_artifacts_with_context(*paths, pyfile=pyfile, archive=archive, file=file)

    def _add_artifacts_with_context(
        self,
        *paths: str,
        pyfile: bool,
        archive: bool,
        file: bool,
        user_context_extensions: Optional[List[any_pb2.Any]] = None,
    ) -> None:
        try:
            for path in paths:
                for attempt in self._retrying():
