    ...
    *,
    ...
    def _converter(
        ...
        if isinstance(dt, ArrayType):
            ...
            return convert_udt
        # BEGIN-EDGE
        # Keep in sync with the same conversion logic in pyspark/sql/pandas/conversion.py
        ...
        # END-EDGE
            ...
            def convert_geography(value: Any) -> Any:
                if value is None:
                    ...
                    # BEGIN-EDGE
                    # Keep in sync with the same conversion logic in pyspark/sql/conversion.py
                    if IS_ENGINE_PYSPARK:
