...
def require_minimum_pandas_version() -> None:
    ...
    # BEGIN-EDGE
    # pandas version on client image v1 is 1.5.3
    # pandas version on client image v2 is 1.5.3
    # pandas version on client image v3 is 1.5.3
    # pandas version on client image v4 is 2.2.3
    # pandas version on client image v5 is 2.2.3
    # END-EDGE
...
def require_minimum_pyarrow_version() -> None:
    ...
    # TODO(HyukjinKwon): Relocate and deduplicate the version specification.
    # BEGIN-EDGE
    # pyarrow version on client image v1 is 8.0.0
    # pyarrow version on client image v2 is 14.0.1
    # pyarrow version on client image v3 is 15.0.2
    # pyarrow version on client image v4 is 19.0.1
    # pyarrow version on client image v5 is 21.0.0
    # ES-1739164: UDTF with arrow enabled failing with client image v1.
    minimum_pyarrow_version = "8.0.0"
    # END-EDGE
...
def require_minimum_numpy_version() -> None:
    ...
    # BEGIN-EDGE
    # numpy version on client image v1 is 1.23.5
    # numpy version on client image v2 is 1.23.5
    # numpy version on client image v3 is 1.26.4
    # numpy version on client image v4 is 2.1.3
    # numpy version on client image v5 is 2.1.3
    # END-EDGE
