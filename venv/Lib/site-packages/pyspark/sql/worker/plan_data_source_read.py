...
if IS_ENGINE_PYSPARK:
    from pyspark._engine_adapters import client_pyspark_datasource, isinstance, type, _client_parse_datatype_json_string
# END-EDGE
...
def _main(infile: IO, outfile: IO) -> None:
    ...
    # BEGIN-EDGE
    # ES-1532659: Client data source would expect schema in client's namespace.
    if IS_ENGINE_PYSPARK:
        # Over-write it to client side struct type.
        schema = _client_parse_datatype_json_string(schema_json)
    # END-EDGE
