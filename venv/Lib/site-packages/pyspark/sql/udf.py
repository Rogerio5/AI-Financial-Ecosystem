...
class UDFRegistration:
    ...
    def register(
        ...
        PipelineSparkConnectMigrationTelemetry.detect_udf_registration(name, f)
        # END-EDGE
    ...
    def registerJavaFunction(
        ...
        # BEGIN-EDGE
        .. connect_migration:: Use `spark.udf.register` in a Scala notebook cell to
            register a Scala UDF; it will be accessible from Python in the same session.
        # END-EDGE
        """
