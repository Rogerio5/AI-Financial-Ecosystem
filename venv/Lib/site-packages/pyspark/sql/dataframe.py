...
class DataFrame:
    ...
    if not is_remote_only():
        ...
        def rdd(self) -> "RDD[Row]":
            ...
            # BEGIN-EDGE
            .. connect_migration:: Use DataFrame operations directly as RDD is not
    ...
    def explain(
        ...
        * Scan ExistingRDD (...)
        ...
        >>> df.explain(mode="cost")  # doctest: +SKIP
        == Optimized Logical Plan ==
        ...Statistics...
        ...
        """
    ...
    def cache(self) -> "DataFrame":
        ...
        # BEGIN-EDGE
        .. serverless_migration:: `DataFrame.cache()` is not supported in Serverless.
            Use `createOrReplaceTempView()` to persist results instead.
        # END-EDGE
        """
        ...
